...
Functions `list-platform-clinics`, `get-platform-clinic-billing` y
`create-platform-clinic`. El listado devuelve resúmenes paginados; el detalle
comercial y sus historiales se solicitan solo al gestionar un consultorio. La
creación
