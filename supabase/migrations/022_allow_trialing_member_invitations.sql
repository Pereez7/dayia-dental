-- Keep atomic clinic invitations compatible with the modern subscription status.
-- The function remains restricted to service_role and keeps all existing limits.
...
comment on function public.insert_clinic_membership_with_limit(
  ...
  'Atomically inserts invited members for eligible trialing or active Medium/Pro clinics.';
